\chapter[Riemann Integration and FTC]{Riemann Integration and the Fundamental Theorem of Calculus}
\label{ch:riemann}
...
Darboux sums measure the oscillation of a function on intervals.  The
criterion below makes this local: integrability is equivalent to confining
all discontinuities to interval covers of arbitrarily small total length.
Thus it begins to distinguish a set that is dense from one that is large in
the relevant covering sense.  We use only countable interval covers, not a
formal theory of Lebesgue measure.
