...
\]
\end{theorem}
The proof is not included here because this appendix uses the recursion
principle as a foundational construction theorem.
...
\end{theorem}
The full set-theoretic proof is not developed here; the following paragraph
records its construction mechanism.
