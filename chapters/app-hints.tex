...
\exercisehint{app-b-2}{Evaluate each proposed composite on a covector and then on a vector. Precomposition determines the arrow order.}

\exercisehint{app-b-3}{For $f:X\to Y$, compare the two routes from $X\times X$ to $Y$ on an arbitrary ordered pair.}
