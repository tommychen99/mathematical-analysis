...
\[
\Delta(t_1,\ldots,t_n)=\prod_{i<j}(t_j-t_i).
\]
...
(-1)^{\sum_j(k_j-1)}.
\]
 Fixed points contribute zero to this exponent.
...
x_j=\sum_i a_{ij}v_i.
\]
 The slot-by-slot uniqueness argument of
...
\[
x_j=\det(A_1,\ldots,b,\ldots,A_n)/\det A
\]
 (Cramer's rule).
\end{hexercise}
