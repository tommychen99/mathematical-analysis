...
\(n_j\uparrow\infty\), and points \(x_j\in[a,b]\) such that
\[
...
|f(s)-f(t)|<\eps/2.
\]
  Split the defining weighted average for
$B_n(f)(x)-f(x)$ according as
\[
|k/n-x|<\delta
\]
 or not.  The first part has
absolute value at most
\[
\eps/2.
\]
  On the second part, the error is at most
$2M$, while
\[
