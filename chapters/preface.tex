...
requires proof unless the prose immediately after its statement explains why
the proof is omitted or deferred and, where useful, supplies a later or
external reference. Proof status is not placed in a mathematical heading.
Examples provide intuition,
...
than relying on calculus folklore. Results not proved in the notes are
identified immediately after their statements. The
...
the compatibility of proper Riemann and Lebesgue integration, the
Lipschitz/a.e. Newton--Leibniz theorem, existence of the Cantor function,
Lebesgue monotone and dominated convergence, and the Lebesgue Fundamental
Theorem of Calculus. These previews clarify
...
Chapter~10 assumes no previous topology or linear algebra course. It
generalizes the real-line topology and compactness introduced in Chapter~5;
its distance examples lead to metric continuity before abstract
