...
theorem without proof. Appendix~\ref{app:foundations} explicitly states
recursion and the equivalence of the choice principles without full proofs;
its Zorn application is proved assuming Zorn. Appendix~\ref{app:cohomology}
